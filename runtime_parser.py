...
def process_runtime_arguments():
    ...
    if len(sys.argv) < 2 or sys.argv[1] == "--help":
        ...
        print "-ovr whether to use one vs the rest classification (the default is one vs one (ovo))"
        ...
        print "NOTE: The default runtime parameters are (-cv kf 5 -m 1 -c 1 -gm 1 -d 3 -r 1 -ovr)"
...
data = argvs[1]
ovx =  "ovr" if "-ovr" in argvs else "ovo"
